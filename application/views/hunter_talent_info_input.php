...
echo 'getLivePlaceDivUrl = "'.site_url('hunter_talent_resume/getLivePlaceDiv').'/'.set_value('province')."/".set_value('city').'";';
echo 'getLivePlaceDivBaseUrl = "'.site_url('hunter_talent_resume/getLivePlaceDiv').'/";';
echo '</script>';
?>
<script type="text/javascript">
	$(document).ready(function()
	{
		$("#livePlace").load(getLivePlaceDivUrl);
		$("#livePlace").change(function()
		{
			var url = getLivePlaceDivBaseUrl + $('#province').val() + "/" + $('#city').val();
			$("#livePlace").load(url);
		});
	});
