<div class="container">
	<div class="span-24 maintext blue">
		...
		<?php
		echo $jobInfo[0]['job_Title'];
		?>
		</h3>
		<hr class="space" />
		<div class="prepend-1 blue">
			<div class="span-3 append-1">
				地点:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray"><?php
				echo $location_display;
				?></span>
			</div>
			<div class="span-3 append-1">
				基本工资:&nbsp;&nbsp;<span class="gray"><?php
				echo $jobInfo[0]['R_salary'];
				?></span>
			</div>
			<div class="span-5 append-1">
				佣金:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray"><?php echo $jobInfo[0]['R_commission']
				?></span>
			</div>
			<div style="clear: both"></div>
			<div class="span-3 append-1">
				人数:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray"><?php echo $jobInfo[0]['job_Recruit_num']
				?></span>
			</div>
			<div class="span-3 append-1">
				需要经验:&nbsp;<span class="gray"><?php echo $jobInfo[0]['R_work_experience']
				?>年</span>
			</div>
			<div class="span-5 append-1">
				有效期:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray"><?php echo $jobInfo[0]['R_period_of_validity']
				?></span>
			</div>
			<div style="clear: both"></div>
			<div class="span-3 append-1">
			...
			<div class="span-8 append-1">
				简述:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray"><?php echo $jobInfo[0]['job_Simple_des']
				?></span>
			</div>
			<div style="clear: both"></div>
			<div class="span-11 append-1">
				职位详述:&nbsp;<span class="gray"><?php echo $jobInfo[0]['job_Detail_des']
				?></span>
			</div>
			<div style="clear: both"></div>
			<hr class="space">
